...
//! let result = 0.1 + 0.2 ❓ 🤔💭
let res= 0.1 + 0.2 
console.log(res)  //Output: 0.30000000000000004 due to machine dont understand floating no.s the only understand binary no.s and here addtion between binany no.s
console.log(res.toFixed(2)); // Output: 0.30
...
var age=18
console.log(age>=18 ? "EligibleToDrive" : "notEligibleToDrive")
...
console.log(2 < 12 < 5);  // true : 2<12=true(1)<5=true

console.log("20" + 10 + 10);// "20"+10=2010(string type)+10=201010

var r="20" + 10 
console.log(r); // "20" + 10 = 2010 (string type)
