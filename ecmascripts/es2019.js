...
// let arr = nestedArray1.flat(2) // here 2 value represent no of array you want to flat 
// let arr1 = nestedArray1.flat(3) // here 2 value represent no of array you want to flat 
// console.log(arr);
// console.log(arr1);
...
// console.log(arr1); //[ [ 'My', 'name' ], [ 'is', 'vinod' ], [ 'thapa' ] ]
// const arr2 = arr.flatMap(item => item.split(" "));
// console.log(arr2) //[ 'My', 'name', 'is', 'vinod', 'thapa' ]
...
// console.log(person == newPerson); // false due to address matched by reference not by value 
