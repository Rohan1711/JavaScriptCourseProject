...
// const paddedCompanyName = companyName.padStart(15);
// const paddedCompanyName = companyName.padStart(5); // not affected any changes if passing value is less than or equal to string length 
// console.log(paddedCompanyName); // Output: "     Kodyfier"
// console.log(companyName.length)
// console.log(paddedCompanyName.length)


//? Using padEnd() to pad from the end:
const companyName = "Kodyfier";
const paddedCompanyName = companyName.padEnd(15,"*")
console.log(paddedCompanyName); // Output:Kodyfier*******
console.log(companyName.length)
console.log(paddedCompanyName.length)
