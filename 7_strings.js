...
// let text2 = 'My name is " Thapa Technical " &\n I am a Full Stack Developer. ';
...
// console.log(text.indexOf("thapa", 7));
...
// let index1 = text.indexOf("JavaScript");
...
// let text = "Hello JavaScript, welcome to our world best JavaScript course";
// let result = text.search(/Javascript/i); // regex where i denoted as case sensitive
// console.log(result);
...
// console.log(matchResult1) //Object [RegExp String Iterator] {}
// let matchResult2 = text.matchAll("JavaScript");
// console.log(matchResult2) //Object [RegExp String Iterator] {}
...
// console.log(...matchResult2);  // spread operator
...
// let includeResult2 = text.includes("Javascript");
// console.log(includeResult1);
// console.log(includeResult2);
...
// let result = text.startsWith("H"); // true
...
// let result1 = text.slice(-6); //course return from backward start from -1===>-6 return till the input that is -6
// console.log(result);
// console.log(result1);
...
//? Optional
// let result = text.replace("JavaScript", ""); //Hello , welcome to our world best JavaScript course
// let result = text.replace("JavaScript","Java"); //Hello , welcome to our world best JavaScript course
...
// // let result = text.charAt(-6); // return empty string
// console.log(result);
...
// for(let char=97; char<=122; char++){
//   console.log(String.fromCharCode(char)) // getting charcter from code fromCharCode()
//   // console.log(char)
// }
...
// return true
// }
// console.log(checkAllVowels("my name u e is vinod thapa"))
